...
echo "  Test     : curl http://local.ankammer.com:8888/ (A renseigner dans /etc/hosts : 127.0.0.1 local.ankammer.com)"
...
echo "  4. curl http://local.ankammer.com:8888/ → {\"message\": \"v2\"}"
echo ""
